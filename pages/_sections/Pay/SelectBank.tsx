  ...
  return (
    <div className="flex flex-col w-full max-w-[564px] p-4 md:p-12 gap-10 shadow-[0_20px_20px_#00000040] rounded-xl">
      ...
      <div className="relative px-4">
        ...
        <div className="bg-[#6EC1E4] h-4 w-24 absolute top-2 left-20 z-0"></div>
      </div>
      ...
      <div className="flex items-center justify-center h-[44.15px] md:h-[64.17px] relative bg-black rounded-[10.7px] cursor-pointer hover:bg-[#6EC1E4] text-white hover:text-black transition-all">
        <img
