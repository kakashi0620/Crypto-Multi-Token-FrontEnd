...
const DashboardPage: NextPage = () => {
  ...
  const getBannerURL = (deal: Deal) => {
    const path = getBackend() + deal.banner.substring(1);
    return path
  }
        ...
        <div className="flex flex-col gap-8 md:gap-16 relative z-10 px-4 md:px-12 py-20 md:0 mx-auto max-w-[1320px]">
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-y-4 md:gap-x-6 md:flex md:flex-row overflow-x-auto whitespace-nowrap">
              ...
              {
                isAdmin() ?
                  <div onClick={() => onCreateDeal()} className="cursor-pointer min-w-[280px] min-h-60 md:w-[350px] md:h-[200px] flex flex-col bg-white border border-gray shadow-2xs rounded-xl dark:border-neutral-700 dark:shadow-neutral-700/70">
