    ...
    <Modal isOpen={isOpen} onClose={onClose} onConfirm={onConfirm} title="">
      <div className="flex flex-col gap-y-10 p-1 md:p-3 text-black">
        ...
        <div className="flex flex-row gap-x-5 w-full justify-center">
          <button
            type="button"
            className="text-white bg-[#6EC1E4] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-[#6EC1E4] dark:focus:ring-blue-800"
            onClick={() => onDetail()}
          >
            Deal Detail
          </button>
