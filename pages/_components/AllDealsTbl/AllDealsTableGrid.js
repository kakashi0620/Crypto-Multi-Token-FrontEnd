...
export default function AllDealsTableGird(props) {
  ...
  React.useEffect(() => {
    ...
    setColumnDefs([
      { field: 'draft', headerName: 'Draft', flex: 1 },
      { field: 'upcoming', headerName: 'Upcoming', flex: 1 },
      { field: 'fundraising', headerName: 'Fundraising', flex: 1 },
      { field: 'closed', headerName: 'Closed', flex: 1 },
      { field: 'distributing', headerName: 'Distributing', flex: 1 },
      { field: 'completed', headerName: 'Completed', flex: 1 },
      { field: 'refunded', headerName: 'Refunded', flex: 1 },
      { field: 'archived', headerName: 'Archived', flex: 1 },
      {
